...
export const routes: Routes = [
  ...
  { path: 'customer/plants/:id', canActivate:[authGuard,roleGuard], data:{roles:['customer']}, loadComponent:()=>import('./features/customer/pages/plant-detail/plant-detail.component').then(m=>m.PlantDetailComponent) },
  ...
  { path: 'customer/wishlist', canActivate:[authGuard,roleGuard], data:{roles:['customer']}, loadComponent:()=>import('./features/customer/pages/wishlist/wishlist.component').then(m=>m.WishlistComponent) },
  { path: 'customer/ai-doctor', canActivate:[authGuard,roleGuard], data:{roles:['customer']}, loadComponent:()=>import('./features/customer/pages/ai-doctor/ai-doctor.component').then(m=>m.AiDoctorComponent) },
